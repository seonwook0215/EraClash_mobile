...
public class EUnitManager : MonoBehaviour
{
    ...
    public void TurnChangeGainArmy()
    {
        ...
        Archer += (EBuildingManager.instance.A_building.Count + EBuildingManager.instance.Fortress_A_building.Count) * 2;
        Shield += (EBuildingManager.instance.S_building.Count + EBuildingManager.instance.Fortress_S_building.Count) * 2;
    }
